...
{
    public class RespodentValidator : AbstractValidator<RespodentAutheDTO>
    {
        public RespodentValidator()
        {
            ...
            RuleFor(x => x.Address.Street)
                .NotNull().WithMessage("Street name is missing from address field")
                .NotEmpty().WithMessage("Street name cant be empty");
